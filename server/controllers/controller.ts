...
import { createData, findAllData, findById, updateData, deleteData, createNewUser } from '../models/usermodel';
import bcrypt from 'bcryptjs';
import {v4 as uuidv4} from 'uuid'; 
import jwt from 'jsonwebtoken';
import { validateUser, validateUserLoginDetails } from '../models/validator';
...
export const addProduct = asyncHandler(async function(req:Request, res: Response, next: NextFunction) {
    const productDetails: IProductNew = req.body;
...
export const updateProductDetails = asyncHandler(async function(req:Request, res: Response, next: NextFunction) {
    ...
    const productDetails: IProductUpdate = req.body;
    const token = req.cookies.token
