...
exports.fetchUsersData = (function () {
    try {
        const data = JSON.parse(fs_1.default.readFileSync(path_1.default.join(__dirname, '..', path_1.default.sep, '..', path_1.default.sep, '/database/userDatabase.json'), 'utf-8'));
        return data;
    }
    catch (error) {
        // Create database if it doesn't exist.
        fs_1.default.writeFileSync(path_1.default.join(__dirname, '..', path_1.default.sep, '..', path_1.default.sep, '/database/userDatabase.json'), JSON.stringify([]), 'utf-8');
        const dataStore = [];
        return dataStore;
    }
});
const writeUsersData = function (result, userStore) {
    ...
    fs_1.default.writeFileSync(path_1.default.join(__dirname, '..', path_1.default.sep, '..', path_1.default.sep, '/database/userDatabase.json'), JSON.stringify(userStore, null, 3), 'utf-8');
};
