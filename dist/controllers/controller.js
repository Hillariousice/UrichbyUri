...
exports.getProducts = (0, express_async_handler_1.default)(function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const data = yield (0, usermodel_1.findAllData)();
...
exports.getProductsById = (0, express_async_handler_1.default)(function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // const user = req.user;
        const data = yield (0, usermodel_1.findById)(id);
        const token = req.cookies.token;
        let user;
        if (token) {
            user = req.cookies.user;
...
exports.addProduct = (0, express_async_handler_1.default)(function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const data = yield (0, usermodel_1.createData)(productDetails);
        const allData = yield (0, usermodel_1.findAllData)();
        const token = req.cookies.token;
        // const user = req.user?.fullname
        let user;
        if (token) {
...
exports.updateProductDetails = (0, express_async_handler_1.default)(function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const productDetails = req.body;
        const token = req.cookies.token;
        const data = yield (0, usermodel_1.updateData)(productDetails);
...
exports.deleteProductDetails = (0, express_async_handler_1.default)(function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        const id = Number(req.params.id);
        const data = yield (0, usermodel_1.deleteData)(id);
        if (data === -1) {
            res.status(404);
...
exports.registerUser = (0, express_async_handler_1.default)(function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const valid = yield (0, validator_1.validateUser)(name, email, password, confirmPassword, gender, phone, address);
        ...
        if (valid) {
            ...
            const newUser = yield (0, usermodel_1.createNewUser)(userId, name, email, hashedPassword, gender, phone, address);
...
exports.loginUser = (0, express_async_handler_1.default)(function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const valid = yield (0, validator_1.validateUserLoginDetails)(email, password, repeat_password);
        if (valid) {
